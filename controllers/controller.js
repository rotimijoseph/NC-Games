const { fetchCategories, fetchReviews, fetchReviewById, fetchCommentsByReviewId, addComment } = require("../models/model");
...
module.exports = { getCategories, getReviews, getReviewById, getCommentsByReviewId, postComments }